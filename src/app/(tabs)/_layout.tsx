...
export default function Layout() {
  ...
  return (
    ...
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: { backgroundColor: colors.background },sceneContainerStyle: {
          backgroundColor: colors.background, // Fills the screen background
        }, }}>
